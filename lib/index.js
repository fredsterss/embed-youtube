...
Youtube.prototype.show = function () {
  swfobject.embedSWF("http://www.youtube.com/v/" + this.id + "?enablejsapi=1&playerapiid=ytplayer&version=3",
                     "video-holder", this.width, this.height, "8", null, null, this.params, this.atts);
